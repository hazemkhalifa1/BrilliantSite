        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HeadlineTop = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HeadlineBottom = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SubText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PrimaryBtnText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PrimaryBtnUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SecondaryBtnText = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SecondaryBtnUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductCategories_ProductBrands_BrandId",
                        column: x => x.BrandId,
