...
$GLOBALS['page_title'] = localized($locale, $product['name'] ?? '', $product['nameAr'] ?? null);
$GLOBALS['meta_description'] = localized($locale, $product['description'] ?? '', $product['descriptionAr'] ?? null);
    ...
    <div class="grid grid-cols-1 items-start gap-12 lg:grid-cols-2">
      ...
      <div class="flex flex-col gap-8">
        ...
        <div class="grid grid-cols-2 gap-4">
          <a href="<?= e($backHref) ?>" class="flex flex-col border-2 border-[#111C2D] bg-white px-10 py-4 font-headline text-sm font-bold uppercase tracking-widest text-[#111C2D] shadow-[4px_4px_0px_0px_#BA1A1A] transition-transform hover:-translate-x-1 hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#BA1A1A]">
          ...
          <div class="flex flex-col border-2 border-[#111C2D] bg-white px-10 py-4 font-headline text-sm font-bold uppercase tracking-widest text-[#111C2D] shadow-[4px_4px_0px_0px_#BA1A1A] transition-transform hover:-translate-x-1 hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#BA1A1A]">
          ...
          <?php endif; ?>
          <a href="<?= e(lnk('/products')) ?>" class="flex flex-col border-2 border-[#111C2D] bg-white px-10 py-4 font-headline text-sm font-bold uppercase tracking-widest text-[#111C2D] shadow-[4px_4px_0px_0px_#BA1A1A] transition-transform hover:-translate-x-1 hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_#BA1A1A]">
    ...
    <section class="bg-neutral-light py-16">
      <div class="container-brilliant">
        ...
        <div class="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <?php foreach ($related as $item): ?><?php $renderProductCard($item, $locale); ?><?php endforeach; ?>
        </div>
      </div>
    </section>
  <?php endif; ?>
