...
<?php if (!$isProductsView): ?>
  <?php
  $phEyebrow = $tp['eyebrow'];
  $phTitle = $tp['title'];
  $phSubtitle = $tp['subtitle'];
  $phBackground = 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?auto=format&fit=crop&w=1920&q=80';
      ...
      <?php if (count($brands) > 0): ?>
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          <?php foreach ($brands as $brand): ?>
            ...
            <a href="<?= e($makeUrl($brand['id'], null, 1)) ?>" class="group block">
