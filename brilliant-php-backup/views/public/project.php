...
<article>
  ...
  <div class="container-brilliant py-12 md:py-16">
    ...
    <h1 class="mt-4 font-headline text-3xl font-bold uppercase leading-tight md:text-5xl"><?= e(localized($locale, $project['title'], $project['titleAr'] ?? null)) ?></h1>
    <span class="mt-4 block h-[3px] w-16 bg-tertiary" aria-hidden="true"></span>

    <div class="mt-8 max-w-3xl space-y-4 leading-relaxed text-neutral/80">
    ...
    <div class="mt-12 grid gap-4 sm:grid-cols-3">
      <div class="card-brilliant bg-neutral-light p-6">
